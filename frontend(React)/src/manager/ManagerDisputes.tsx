...
/** Map DB status to existing CSS modifiers (pending / investigating / resolved / rejected). */
        ...
        <div className="manager-dash__main manager-disputes__main">
          ...
          <div className="manager-disputes__bound">
            <div className="manager-disputes__head">
              ...
              <p className="manager-dash__page-sub">Live disputes from Supabase (same data as the mobile app)</p>
              <button
                type="button"
          ...
          >
            ...
            <div className="manager-disputes__modal-body">
              ...
              <p className="text-xs text-muted-foreground mt-2 mb-2">
                Visible to the customer; may trigger notifications (same as mobile).
              </p>
