  ...
  build: {
    rollupOptions: {
      input: {
        ...
        featuredEvents: path.resolve(__dirname, 'featured-events.html'),
        platformAnalytics: path.resolve(__dirname, 'platform-analytics.html'),
        platformSettings: path.resolve(__dirname, 'platform-settings.html'),
      },
    },
  },
})
